...
type RadioGroupItemProps = React.ComponentPropsWithoutRef<typeof RadioGroupPrimitive.Item> & React.HTMLAttributes<HTMLElement>;
const RadioGroupItem = React.forwardRef<React.ElementRef<typeof RadioGroupPrimitive.Item>, RadioGroupItemProps>(({ className, ...props }, ref) => {
  return (
    <_RadioGroupPrimitiveItem
      ...
      {...(props as unknown as React.ComponentPropsWithoutRef<typeof RadioGroupPrimitive.Item>)}
    >
